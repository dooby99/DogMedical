...
import com.example.petmedical.image.AlbumActivity
import com.example.petmedical.map.ConvertActivity
import net.daum.android.map.MapActivity
import com.example.petmedical.guideline.GuideLine
import com.example.petmedical.guideline.SliderMainActivity
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private val Guide = View.OnClickListener {
        val intent = Intent(this, SliderMainActivity::class.java)
        startActivity(intent)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.guidebutton.setOnClickListener(Guide)
        Log.i("MainActivity", "onCreate")
    }
